...
function Input(props) {
  return (
    <input
      {...props}
      className="w-full bg-transparent text-lg p-4 border rounded-xl border-onix outline-none focus:border-platinum"
    />
  );
}
...
const validationSchema = yup.object({
  ...
  username: yup.string().required("Usuário"),
  email: yup.string().required("Email").email("Email inválido"),
      ...
      <div className="flex-1 flex justify-center items-center p-14 space-y-6">
        <div className="max-w-md flex-1">
          ...
          <form className="space-y-6">
            ...
            {error ? (
              <div className="text-red-500 text-xm">{error.data}</div>
            ) : null}
          </form>
